 ...
 * generated in the demo.ws.soap_spring_cxf package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://soap_spring_cxf.ws.demo/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://soap_spring_cxf.ws.demo/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: demo.ws.soap_spring_cxf
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap_spring_cxf.ws.demo/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap_spring_cxf.ws.demo/", name = "sayResponse")
