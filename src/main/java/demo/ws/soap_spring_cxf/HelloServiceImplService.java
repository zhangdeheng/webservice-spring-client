 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://soap_spring_cxf.ws.demo/", wsdlLocation = "http://localhost:8080/wsService/ws/soap/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://soap_spring_cxf.ws.demo/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/wsService/ws/soap/hello?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://soap_spring_cxf.ws.demo/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap_spring_cxf.ws.demo/", "HelloServiceImplPort"), HelloService.class, features);
    }
